      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Share your competition-winning document with the community. Help others learn from your success.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Upload your PDF, Word, or PowerPoint files (max 50MB each)</CardDescription>
            </CardHeader>
            <CardContent>
              <div
                {...getRootProps()}
              ...
              >
                ...
                {isDragActive ? (
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Supports PDF, DOC, DOCX, PPT, PPTX</p>
                  </div>
                )}
              </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Provide details about your document to help others discover it</CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Add relevant topics and companies to improve discoverability</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              {/* Topics */}
                  ...
                  <div className="flex flex-wrap gap-2">
                    {formData.companies.map((company) => (
                      <Badge key={company} variant="outline" className="gap-1">
                        {company}
                        <button type="button" onClick={() => removeCompany(company)} className="hover:text-destructive">
                          <X className="h-3 w-3" />
                        </button>
                      </Badge>
                    ))}
          ...
          <div className="flex justify-end gap-4">
            ...
            <Button type="submit" disabled={uploadedFiles.length === 0 || isUploading} className="min-w-32">
